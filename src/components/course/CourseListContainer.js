                ...
                <div className="row mt-3">
                    <div className="col">
                        <div className="btn-group" role="group">
                            ...
                            >
                                <i className="fa fa-plus" aria-hidden="true"/> Add Trade
                            </button>
                            ...
                            >
                                <i className="fa fa-pencil" aria-hidden="true"/> Edit Trade
                            </button>                                
                            ...
                            >
                                <i className="fa fa-trash-o" aria-hidden="true" onClick={this.handleDelete}/> Delete Trade
                            </button>
                        </div>
                    </div>
                </div>
